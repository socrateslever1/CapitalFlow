...
O fluxo de atendimento do cliente é determinístico: contato fora da base não recebe menu automático e contato identificado só fala com o robô quando já existe sessão válida no backend.
