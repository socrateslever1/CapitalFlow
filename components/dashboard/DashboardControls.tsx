...
export const DashboardControls: React.FC<DashboardControlsProps> = ({
    ...
    return (
        <div className="flex flex-col gap-3 relative z-30">
                ...
                <div className="flex items-center gap-2 mb-2">
                    ...
                    <div className="flex-1 relative group">
                        <select
                            ...
                            className="w-full appearance-none bg-slate-900 border border-slate-800 rounded-lg px-4 py-2.5 pr-10 text-[10px] font-black uppercase text-white outline-none focus:border-indigo-500 transition-all cursor-pointer hover:bg-slate-800"
                        >
            ...
            <div className="flex items-center gap-3 w-full">
                <div className="flex gap-1.5 flex-shrink-0">
                    <button
                        ...
                        className={`p-2.5 rounded-lg border transition-all ${isSearchOpen ? 'bg-gradient-to-br from-blue-600 to-blue-700 border-blue-500 text-white shadow-lg shadow-blue-600/20' : 'bg-slate-900 border-slate-800 text-slate-400 hover:bg-slate-800'}`}
                        title="Buscar"
                    >
                        <Search size={18} />
                    </button>
                    <button
                        ...
                        className={`p-2.5 rounded-lg border transition-all ${isSortOpen ? 'bg-gradient-to-br from-blue-600 to-blue-700 border-blue-500 text-white shadow-lg shadow-blue-600/20' : 'bg-slate-900 border-slate-800 text-slate-400 hover:bg-slate-800'}`}
                        title="Ordenar"
                    >
                ...
                >
                    <div className="flex gap-2 p-1.5 bg-slate-900/50 border border-slate-800/80 rounded-lg w-max">
                        {[
            ...
            {isSearchOpen && (
                <div className="mt-2 bg-slate-900 border border-slate-800 p-1.5 rounded-lg flex items-center gap-1 animate-in slide-in-from-top-2 duration-200 shadow-2xl shadow-black/50">
            ...
            {isSortOpen && (
                <div className="absolute top-full left-0 mt-2 bg-slate-900 border border-slate-800 p-1.5 rounded-lg flex flex-col gap-1 animate-in slide-in-from-top-2 duration-200 z-50 w-full md:max-w-[300px] shadow-2xl shadow-black/50">
