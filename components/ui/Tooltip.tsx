...
export const Tooltip: React.FC<TooltipProps> = ({ content, children, position = 'bottom' }) => {
  return (
    <div className="relative flex items-center justify-center group z-50">
      ...
      >
        <span className="relative z-50 px-3 py-2 text-[9px] font-black text-slate-200 bg-slate-900 rounded-lg shadow-2xl border border-slate-700 uppercase tracking-widest backdrop-blur-md">
          {content}
