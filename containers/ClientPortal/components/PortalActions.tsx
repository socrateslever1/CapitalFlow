...
export const PortalActions: React.FC<PortalActionsProps> = ({ onOpenLegal }) => {
    return (
        <button onClick={onOpenLegal} className="w-full bg-slate-800 border border-slate-700 p-4 rounded-lg flex items-center justify-between group hover:bg-slate-700 transition-all">
