      ...
      <div className="flex flex-col gap-4 overflow-y-auto max-h-[70vh] px-1 custom-scrollbar">
        ...
        <div className="relative">
            <input
              ...
              className="w-full bg-slate-950/50 border border-slate-800 rounded-lg px-4 py-3 text-lg font-bold text-white outline-none focus:border-blue-500 transition-colors placeholder:text-slate-500"
              value={title}
        ...
        <div className="grid grid-cols-2 gap-3">
            <div className="bg-slate-950 border border-slate-800 rounded-lg p-2 flex flex-col relative group focus-within:border-blue-500 transition-colors">
        ...
        <div className="relative group">
            <textarea
                ...
                className="w-full bg-slate-950 border border-slate-800 rounded-lg p-4 text-white text-xs leading-relaxed h-24 resize-none outline-none focus:border-blue-500 transition-colors"
                value={description}
        ...
        <div className="flex gap-3 mt-2">
            {initialData && (
                <button
                    ...
                    className="flex-1 py-3 bg-emerald-900/20 text-emerald-500 border border-emerald-500/20 rounded-lg text-xs font-black uppercase hover:bg-emerald-900/40 transition-colors flex items-center justify-center gap-2"
                >
                    <CheckCircle size={16}/> Feito
                </button>
            )}
            <button onClick={handleSubmit} className="flex-[2] py-3 bg-blue-600 text-white rounded-lg text-xs font-black uppercase shadow-lg shadow-blue-600/20 hover:bg-blue-500 transition-all active:scale-95">
