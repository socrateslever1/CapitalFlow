...
export const ExecutionPipeline: React.FC<ExecutionPipelineProps> = ({ fullAuditData, onGeneratePDF }) => {
    ...
    return (
        <div className="space-y-6 animate-in slide-in-from-right">
            ...
            <div className={`p-5 rounded-lg border text-center ${allReady ? 'bg-blue-900/20 border-blue-500/30' : 'bg-slate-900 border-slate-800'}`}>
                ...
                <button
                    ...
                    disabled={!allReady}
                    className="w-full py-4 bg-blue-600 disabled:bg-slate-800 disabled:text-slate-500 text-white rounded-lg font-black uppercase text-xs shadow-lg transition-all flex items-center justify-center gap-2"
                >
