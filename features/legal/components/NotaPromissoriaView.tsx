...
import { Printer, Landmark, Scale, Calendar } from 'lucide-react';
        ...
        <div className="space-y-6 animate-in slide-in-from-right duration-300">
            <div className="mb-6">
                ...
                <div className="mt-3 flex items-center gap-3">
                    <div className="w-10 h-10 bg-indigo-600/20 border border-indigo-500/30 text-indigo-400 rounded-lg flex items-center justify-center shrink-0 shadow-lg shadow-indigo-950/40"><Printer size={20} /></div>
                    <div>
                        <h1 className="text-base font-black text-white uppercase tracking-wider leading-tight">Notas Promissórias</h1>
                        <p className="text-[10px] font-bold text-slate-500 uppercase tracking-widest mt-0.5">Garantia Líquida e Certa (Dec. 2.044/1908)</p>
                    </div>
                </div>
            </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
                {activeLoans.map(loan => (
                    <div key={loan.id} className="bg-slate-900 border border-slate-800 p-6 rounded-lg flex flex-col group hover:border-blue-500 transition-all">
                        <div className="flex justify-between items-start mb-4">
                            <div className="p-3 bg-blue-500/10 text-blue-500 rounded-lg"><Landmark size={24}/></div>
                        ...
                        <div className="mt-auto pt-4 border-t border-slate-800 flex items-center justify-between">
                            ...
                            <Tooltip content="Gerar documento para impressão" position="top">
                                <button
                                    ...
                                    className="px-5 py-3 bg-slate-800 text-blue-400 hover:text-white hover:bg-blue-600 rounded-lg text-[10px] font-black uppercase transition-all flex items-center gap-2"
                                >
