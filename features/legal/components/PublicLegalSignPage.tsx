...
export const PublicLegalSignPage: React.FC<PublicLegalSignPageProps> = ({ token }) => {
    ...
    if (status === 'ERROR') return (
        <div className="min-h-screen bg-slate-950 flex items-center justify-center p-4">
            <div className="bg-rose-900/20 border border-rose-500 p-8 rounded-lg text-center max-w-md shadow-2xl">
                ...
                <button
                    ...
                    className="mt-6 px-6 py-3 bg-rose-600 text-white rounded-lg font-black uppercase text-xs hover:bg-rose-500 transition-all"
                >
                    Tentar Novamente
                </button>
            </div>
                ...
                <div className="max-w-4xl mx-auto bg-white shadow-2xl min-h-[900px] rounded-lg overflow-hidden relative">
                    {status === 'SIGNING' && (
                        <div className="absolute inset-0 bg-white/50 backdrop-blur-[2px] z-50 flex items-center justify-center">
                            <div className="bg-slate-900 p-8 rounded-lg shadow-2xl flex flex-col items-center gap-4 border border-slate-800 animate-in zoom-in-95">
            ...
            <div className="w-full lg:w-[420px] bg-slate-900 border-t lg:border-l border-slate-800 p-6 flex flex-col shadow-2xl z-20">
                ...
                {status === 'SUCCESS' ? (
                    <div className="flex-1 flex flex-col items-center justify-center text-center space-y-6 animate-in zoom-in duration-500">
                        ...
                        <button onClick={() => window.close()} className="w-full py-5 bg-slate-800 text-white rounded-lg font-black uppercase text-xs hover:bg-slate-700 transition-all">Encerrar Sessão</button>
                    </div>
                ) : (
