        ...
        <Modal onClose={onClose} title="Gestão de Credenciais (SAC)">
            <div className="space-y-5">
                <div className="bg-slate-950 p-4 rounded-lg border border-slate-800 flex items-center gap-4">
                    <div className={`p-3 rounded-lg ${formData.access_level === 1 ? 'bg-rose-500/20 text-rose-500' : 'bg-blue-500/20 text-blue-500'}`}>
                        <Shield size={24} />
                    </div>
                    <div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="space-y-1">
                        ...
                        <input
                            type="text"
                            className="w-full bg-slate-950 border border-slate-800 rounded-lg p-3 text-white text-sm font-bold outline-none focus:border-blue-500 transition-colors"
                ...
                <div className="pt-4 border-t border-slate-800">
                    ...
                    <input
                        type="text"
                        className="w-full bg-slate-950 border border-rose-900/30 rounded-lg p-3 text-rose-200 text-sm font-bold outline-none focus:border-rose-500 transition-colors placeholder:text-rose-900/50"
                ...
                <div className="flex gap-3 pt-2">
                    <button onClick={onClose} className="flex-1 py-3 bg-slate-900 text-slate-400 rounded-lg font-black uppercase text-xs hover:bg-slate-800 hover:text-white transition-colors">Cancelar</button>
                    <button
                        onClick={handleSave}
                        disabled={isSaving}
                        className="flex-[2] py-3 bg-blue-600 text-white rounded-lg font-black uppercase text-xs hover:bg-blue-500 transition-colors flex items-center justify-center gap-2 disabled:opacity-50"
                    >
