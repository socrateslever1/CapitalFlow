    ...
    <div className="space-y-6">
      ...
      <div className="space-y-6 bg-slate-950 p-6 rounded-lg border border-slate-800 shadow-xl">
        ...
        <div>
          ...
          <div className="relative">
            <input
              ...
              placeholder="$a..."
              className="w-full bg-slate-900 border border-slate-800 rounded-lg p-4 text-white font-mono text-sm outline-none focus:border-amber-500 transition-all shadow-inner"
            />
            {apiKey && (
        ...
        <button
          onClick={handleSave}
          disabled={isSaving}
          className="w-full py-4 bg-amber-600 hover:bg-amber-500 disabled:bg-slate-800 text-white rounded-lg font-bold uppercase text-xs transition-all flex items-center justify-center gap-2 shadow-lg shadow-amber-900/20"
        >
          {isSaving ? (
