    ...
    return (
        <Modal onClose={closeModal} title="Zerar Dados">
            <div className="space-y-6">
                <div className="bg-rose-500/10 border border-rose-500/20 p-5 rounded-lg flex items-start gap-4">
                ...
                <div className="space-y-4 pt-4 border-t border-slate-800">
                    <div>
                        ...
                        <div className="relative">
                            ...
                            <input
                                ...
                                className="w-full bg-slate-950 border border-slate-800 rounded-lg py-4 pl-12 pr-4 text-white font-bold outline-none focus:border-rose-500 transition-colors"
                    ...
                    <button
                        ...
                        className="w-full py-4 bg-rose-600 hover:bg-rose-500 text-white rounded-lg font-black uppercase text-xs shadow-lg flex items-center justify-center gap-3 transition-all disabled:opacity-50"
                    >
...
export const DeleteAccountModal: React.FC<DangerModalProps> = ({ ui, closeModal, activeUser, onExecute }) => {
    ...
    return (
        <Modal onClose={closeModal} title="Excluir Conta Permanentemente">
            <div className="space-y-6">
                <div className="bg-rose-600 p-6 rounded-lg text-white relative overflow-hidden shadow-xl">
                ...
                <div className="space-y-4">
                    <label className="flex items-start gap-4 p-4 bg-slate-950 border border-slate-800 rounded-lg cursor-pointer group hover:border-rose-500/50 transition-colors">
                        <input
                            type="checkbox"
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                            <div>
                                ...
                                <input
                                    ...
                                    value={ui.resetPasswordInput || ''}
                                    onChange={e => ui.setResetPasswordInput(e.target.value)}
                                    className="w-full bg-slate-950 border border-slate-800 rounded-lg p-4 text-white font-bold text-sm outline-none focus:border-rose-500"
                ...
                <button
                    ...
                    className="w-full py-5 bg-rose-600 hover:bg-rose-500 text-white rounded-lg font-black uppercase text-xs shadow-xl transition-all disabled:opacity-30 flex items-center justify-center gap-3"
                >
