                ...
                <div className="flex gap-3 pt-2">
                    {isEditing && onDelete && (
                        <button
                            ...
                            disabled={isLoading}
                            className="p-4 bg-rose-950/30 text-rose-500 border border-rose-500/20 rounded-lg hover:bg-rose-950/50 transition-all flex items-center justify-center"
                    ...
                    <button
                        ...
                        className="flex-1 py-4 bg-blue-600 hover:bg-blue-500 disabled:opacity-50 text-white rounded-lg font-black uppercase text-xs flex items-center justify-center gap-2 shadow-lg transition-all"
                    >
