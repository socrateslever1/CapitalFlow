  ...
  return (
    <div className="min-h-screen bg-slate-950 flex flex-col items-center justify-center p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="bg-slate-900 border border-slate-800 rounded-lg p-6 sm:p-8 shadow-xl">
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <button
              ...
              className="w-full py-4 bg-emerald-600 hover:bg-emerald-500 text-white rounded-lg font-black uppercase text-xs flex items-center justify-center gap-2 shadow-lg shadow-emerald-600/20 transition-all mt-6 disabled:opacity-50 disabled:cursor-not-allowed"
            >
