        ...
        <div className="space-y-8 animate-in fade-in duration-500">
            ...
            <div className="bg-slate-900 border border-slate-800 p-6 sm:p-8 rounded-lg">
                ...
                <div className="flex items-center gap-3 mb-8 pb-6 border-b border-slate-800">
                    <div className="p-3 bg-blue-600/10 text-blue-500 rounded-lg"><Cpu size={24}/></div>
                    <div>
                ...
                <div className="space-y-8">
                    ...
                    <div className="space-y-3">
                        ...
                        <ul className="bg-slate-950 p-4 rounded-lg border border-slate-800 space-y-2">
                    ...
                    <div className="space-y-3">
                        ...
                        <div className="bg-rose-950/10 p-4 rounded-lg border border-rose-500/20 text-xs text-rose-200/80 leading-relaxed">
