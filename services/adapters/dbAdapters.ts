...
export const mapLoanFromDB = (l: any, clientsData: any[] = []): Loan => {
  ...
  const installments = rawParcelas.map((p: any) => {
    ...
    return {
      ...
      paymentOfferAgreedDate: safeDateString(p.payment_offer_agreed_date),
      paymentOfferValidUntil: safeDateString(p.payment_offer_valid_until),
      paymentOfferDiscountPercent: asNumber(p.payment_offer_discount_percent),
      paymentOfferDiscountValue: asNumber(p.payment_offer_discount_value),
      paymentOfferDiscountApplied: asNumber(p.payment_offer_discount_applied),
      paymentOfferWaiveLateFee: Boolean(p.payment_offer_waive_late_fee),
      paymentOfferWaiveFine: Boolean(p.payment_offer_waive_fine),
      paymentOfferWaiveDailyInterest: Boolean(p.payment_offer_waive_daily_interest),
      paymentOfferFineAmount: asNumber(p.payment_offer_fine_amount),
      paymentOfferDailyInterestAmount: asNumber(p.payment_offer_daily_interest_amount),
      paymentOfferFineForgiven: asNumber(p.payment_offer_fine_forgiven),
      paymentOfferDailyInterestForgiven: asNumber(p.payment_offer_daily_interest_forgiven),
      paymentOfferOriginalAmount: asNumber(p.payment_offer_original_amount),
      paymentOfferLateFeeForgiven: asNumber(p.payment_offer_late_fee_forgiven),
      paymentOfferGrossAmount: asNumber(p.payment_offer_gross_amount),
      paymentOfferAmount: asNumber(p.payment_offer_amount),
      paymentOfferNote: asString(p.payment_offer_note),
      paymentOfferCreatedAt: safeDateString(p.payment_offer_created_at),
      logs: []
    };
  });
