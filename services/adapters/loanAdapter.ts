...
export function mapLoanFromDB(
  ...
  const installments: Installment[] = asArray(rawInstallments).map((inst: any) => {
    ...
    return {
      ...
      paymentOfferAgreedDate: safeDateString(inst?.payment_offer_agreed_date ?? inst?.paymentOfferAgreedDate),
      paymentOfferValidUntil: safeDateString(inst?.payment_offer_valid_until ?? inst?.paymentOfferValidUntil),
      paymentOfferDiscountPercent: asNumber(inst?.payment_offer_discount_percent ?? inst?.paymentOfferDiscountPercent),
      paymentOfferDiscountValue: asNumber(inst?.payment_offer_discount_value ?? inst?.paymentOfferDiscountValue),
      paymentOfferDiscountApplied: asNumber(inst?.payment_offer_discount_applied ?? inst?.paymentOfferDiscountApplied),
      paymentOfferWaiveLateFee: !!(inst?.payment_offer_waive_late_fee ?? inst?.paymentOfferWaiveLateFee),
      paymentOfferWaiveFine: !!(inst?.payment_offer_waive_fine ?? inst?.paymentOfferWaiveFine),
      paymentOfferWaiveDailyInterest: !!(inst?.payment_offer_waive_daily_interest ?? inst?.paymentOfferWaiveDailyInterest),
      paymentOfferFineAmount: asNumber(inst?.payment_offer_fine_amount ?? inst?.paymentOfferFineAmount),
      paymentOfferDailyInterestAmount: asNumber(inst?.payment_offer_daily_interest_amount ?? inst?.paymentOfferDailyInterestAmount),
      paymentOfferFineForgiven: asNumber(inst?.payment_offer_fine_forgiven ?? inst?.paymentOfferFineForgiven),
      paymentOfferDailyInterestForgiven: asNumber(inst?.payment_offer_daily_interest_forgiven ?? inst?.paymentOfferDailyInterestForgiven),
      paymentOfferOriginalAmount: asNumber(inst?.payment_offer_original_amount ?? inst?.paymentOfferOriginalAmount),
      paymentOfferLateFeeForgiven: asNumber(inst?.payment_offer_late_fee_forgiven ?? inst?.paymentOfferLateFeeForgiven),
      paymentOfferGrossAmount: asNumber(inst?.payment_offer_gross_amount ?? inst?.paymentOfferGrossAmount),
      paymentOfferAmount: asNumber(inst?.payment_offer_amount ?? inst?.paymentOfferAmount),
      paymentOfferNote: asString(inst?.payment_offer_note ?? inst?.paymentOfferNote),
      paymentOfferCreatedAt: safeDateString(inst?.payment_offer_created_at ?? inst?.paymentOfferCreatedAt),
    } as Installment;
  });
