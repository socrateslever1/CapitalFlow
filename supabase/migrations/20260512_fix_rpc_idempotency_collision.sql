...
-- Migração: 20260512_fix_rpc_idempotency_collision.sql
-- Descrição: Resolve o erro de chave duplicada ao registrar Principal e Lucro simultaneamente no RPC.
...
BEGIN
  ...
  -- 1. Verificar idempotência (Evita processamento duplicado da função)
